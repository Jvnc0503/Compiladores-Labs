...
class Token {
public:
    enum Type { LPAREN, RPAREN, PLUS, MINUS, MULT, DIV, POW, NUM, ERR, END, FLOAT, ID, LOG, EXP };
...
const char *Token::token_names[14] = {
    "LPAREN", "RPAREN", "PLUS", "MINUS", "MULT", "DIV", "POW", "NUM", "ERR", "END", "FLOAT", "ID", "LOG", "EXP"
};
    ...
    while (1) {
        switch (state) {
            ...
            case 14: rollBack();
                ...
                if (getLexema() == "exp") return new Token(Token::EXP, getLexema());
