...
WhileStatement::WhileStatement(Exp *condition, Body *body): condition(condition), body(body) {
}
...
ForStatement::ForStatement(AssignStatement *init, Exp *condition, AssignStatement *increment, Body *body): init(init),
